...
from apps.accounts.services import get_user_by_email, get_user_details
...
class ForgetPasswordRequestView(BaseGenericAPIView):
    ...
    def post(self, request):
        ...
        try:
            user = get_user_by_email(email=serializer.data["email"])

        except Exception as exc:
            raise UserNotFoundAPIException() from exc
