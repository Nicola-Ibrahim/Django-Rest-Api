...
class UserListCreateView(
    ...
    # permission_classes = [permissions.UserListPermission, permissions.UserCreatePermission]
    ...
    def get(self, request, *args, **kwargs):
        ...
        return responses.UserListResponse(serializer.data)
...
class UserDetailsUpdateDestroyView(
    ...
    permission_classes = [permissions.UserUpdatePermission, permissions.UserDeletePermission, IsAuthenticated]
